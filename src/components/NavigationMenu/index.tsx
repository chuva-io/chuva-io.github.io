...
export default () => (
  // <NavigationMenu className="relative z-50 max-w-screen-xl mx-auto">
  //   <NavigationMenuList>
  //     <NavigationMenuItem>
  ...
  <ul className="flex items-center justify-center gap-8 text-lg text-white">
    {links.map((link) => (
      <li
        key={link.href}
        className={`bg-gradient-to-r ${from} ${via} ${to} hover:text-transparent bg-clip-text bg-[length:300%_100%] animate-gradient`}
      >
